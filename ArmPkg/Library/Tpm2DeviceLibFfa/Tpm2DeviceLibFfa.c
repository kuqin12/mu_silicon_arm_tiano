  ...
  )
{
  ...
  switch (FfaReturnStatus) {
    ...
    case ARM_FFA_SPM_RET_NO_MEMORY:
    ...
    case ARM_FFA_SPM_RET_INTERRUPTED:
    ...
    case ARM_FFA_SPM_RET_NO_DATA:
      Status = EFI_NOT_FOUND;
      break;

    case ARM_FFA_SPM_RET_NOT_READY:
